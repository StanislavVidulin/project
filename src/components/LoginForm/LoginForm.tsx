...
// аргумент - объект, с данными (настройкой) определённой формы.
...
const formik = useFormik({
    ...
    // validationSchema - свойство, в значение которого 
    // добавляют ранее созданную валидационную схему (через Yup)
...
console.log(formik);
  ...
  return (
    ...
    <LoginFormComponent onSubmit={formik.handleSubmit}>
      ...
      для value - {formik.values.name} (name - шаблон (здесь нужно точное название элемента))
